...
export const SCREENS: ScreenDef[] = [
  ...
  },
  {
    name: 'cloud-session',
    group: 'Cloud',
    title: 'Agent · Session lookup',
    component: CloudAgentSessionScreen,
  },
  ...
  { name: 'security-findings', group: 'Security', title: 'Findings', component: FindingsScreen },
  {
    ...
    title: 'Finding',
    hidden: true,
    component: FindingDetailWrapper,
  },
  {
    name: 'security-repos',
    group: 'Security',
    title: 'Repositories',
    component: SecurityReposScreen,
  },
  ...
  },
  {
    ...
    group: 'Security',
    title: 'Commands',
    component: SecurityCommandsScreen,
  },
  ...
  },
  {
    ...
    group: 'Usage',
    title: 'Timeseries',
    component: AnalyticsTimeseriesScreen,
  },
  {
    name: 'analytics-breakdown',
    group: 'Usage',
    title: 'Breakdown',
    component: AnalyticsBreakdownScreen,
  },
  ...
  // KiloClaw
  {
    name: 'kiloclaw-instances',
    group: 'KiloClaw',
    title: 'Instances',
    component: KiloclawInstancesScreen,
  },
  { name: 'kiloclaw-agents', group: 'KiloClaw', title: 'Agents', component: KiloclawAgentsScreen },
  {
    name: 'kiloclaw-billing',
    group: 'KiloClaw',
    title: 'Billing',
    component: KiloclawBillingScreen,
  },
  {
    name: 'kiloclaw-history',
    group: 'KiloClaw',
    title: 'Billing History',
    component: KiloclawHistoryScreen,
  },
  {
    name: 'kiloclaw-subscriptions',
    group: 'KiloClaw',
    title: 'Subscriptions',
    component: KiloclawSubscriptionsScreen,
  },
  {
    name: 'kiloclaw-changelog',
    group: 'KiloClaw',
    title: "What's New",
    component: KiloclawChangelogScreen,
  },
  {
    name: 'kiloclaw-version',
    group: 'KiloClaw',
    title: 'Version',
    component: KiloclawVersionScreen,
  },
