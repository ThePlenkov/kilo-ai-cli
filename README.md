...
2. It prints a verification URL and opens your default browser.
3. You authorize the request in the browser.
4. The CLI polls the API until authorization completes.
...
kilo-ai-cli org members               # List organization members
kilo-ai-cli org usage                  # Show organization usage
kilo-ai-cli org credits               # Show organization credits
kilo-ai-cli org seats                 # Show organization seats
kilo-ai-cli org invoices              # List organization invoices
kilo-ai-cli org create                # Create a new organization
kilo-ai-cli org update                # Update organization settings
kilo-ai-cli org models                # List available models for the organization
kilo-ai-cli org security              # Show organization security settings
```
...
```text
kilo-ai-cli reviews list                           # List code reviews
kilo-ai-cli reviews config                         # Show review configuration
kilo-ai-cli reviews toggle                         # Toggle code reviews on/off
```
